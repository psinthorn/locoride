          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-4">
              <div>
                  ...
                  <ul className="text-gray-500 dark:text-gray-400 font-medium gap-4">
                      <li className="mb-4">
                          <a href="https://flowbite.com/" className="hover:underline">Tel: +669 999 9999</a>
                      </li>
                      <li className="mb-4">
                          <a href="https://tailwindcss.com/" className="hover:underline">Email: info@ros.com</a>
                      </li>
                      <li>
                          <a href="https://tailwindcss.com/" className="hover:underline">Line Official: @ros</a>
                      </li>
                  </ul>
              </div>
